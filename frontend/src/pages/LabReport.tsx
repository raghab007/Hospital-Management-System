  ...
  const labTests = [
    {
      ...
      tests: [
        ...
        { name: "Blood Sugar (Fasting)", price: "$15", duration: "1 hour", popular: false },
        { name: "Lipid Profile", price: "$30", duration: "4-6 hours", popular: true },
        { name: "Liver Function Test", price: "$35", duration: "4-6 hours", popular: false },
        { name: "Kidney Function Test", price: "$28", duration: "2-4 hours", popular: false }
      ]
    },
    {
      ...
      color: "red",
      tests: [
        { name: "X-Ray (Chest)", price: "$40", duration: "30 minutes", popular: false },
        { name: "CT Scan", price: "$200", duration: "1-2 hours", popular: true },
        { name: "MRI Scan", price: "$350", duration: "2-3 hours", popular: false },
        { name: "Ultrasound", price: "$80", duration: "45 minutes", popular: true },
        { name: "Mammography", price: "$120", duration: "1 hour", popular: false }
      ]
    },
    {
      ...
      color: "red",
      tests: [
        { name: "ECG (Electrocardiogram)", price: "$50", duration: "30 minutes", popular: true },
        { name: "Echocardiogram", price: "$150", duration: "1 hour", popular: false },
        { name: "Stress Test", price: "$180", duration: "2 hours", popular: false },
        { name: "Holter Monitor", price: "$200", duration: "24 hours", popular: false }
      ]
    },
    {
      ...
      color: "red",
      tests: [
        { name: "Thyroid Function Test", price: "$45", duration: "4-6 hours", popular: true },
        { name: "Vitamin D Test", price: "$35", duration: "2-4 hours", popular: false },
        { name: "Cancer Markers", price: "$85", duration: "1-2 days", popular: false },
        { name: "Allergy Panel", price: "$120", duration: "3-5 days", popular: false }
      ]
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
              ...
              Our state-of-the-art laboratory ensures reliable and precise medical testing.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 mb-6">Schedule your laboratory tests online with our easy booking system</p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 mb-6">Access your test results online securely and instantly</p>
              <button className="w-full bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors font-semibold">
                View Reports
              </button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 mb-6">Sample collection at your doorstep for your convenience</p>
              <button className="w-full bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors font-semibold">
                Schedule
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive range of diagnostic tests with accurate results and quick turnaround
            </p>
          </div>
            ...
            {labTests.map((category, index) => (
              <div key={index} className="bg-gray-50 rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                <div className="flex items-center mb-6">
                  <div className={`w-16 h-16 bg-${category.color}-50 rounded-full flex items-center justify-center mr-4`}>
                ...
                <div className="space-y-4">
                  {category.tests.map((test, testIndex) => (
                    <div key={testIndex} className="flex justify-between items-center p-4 bg-white rounded-lg hover:bg-gray-50 transition-colors border border-gray-100">
                      ...
                      <div className="text-right ml-4">
                        <p className="font-bold text-red-600 text-lg">{test.price}</p>
                        <button className={`text-sm bg-red-100 text-red-600 px-3 py-1 rounded hover:bg-red-200 transition-colors font-semibold`}>
                          Book Test
                        </button>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-800">Recent Lab Reports</h2>
                ...
                <tbody>
                  {recentReports.map((report) => (
                    <tr key={report.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      <td className="py-3 px-4 font-mono text-sm font-semibold text-red-600">{report.id}</td>
                      <td className="py-3 px-4 font-medium">{report.patientName}</td>
                      <td className="py-3 px-4">{report.testName}</td>
                      <td className="py-3 px-4 text-gray-600">{report.date}</td>
                      <td className="py-3 px-4">
                        <span className={`px-2 py-1 rounded-full text-xs font-semibold ${report.priority === 'High'
                      ...
                      <td className="py-3 px-4">
                        <span className={`px-2 py-1 rounded-full text-xs font-semibold ${report.status === 'Ready'
                      ...
                      <td className="py-3 px-4 text-gray-600">{report.doctor}</td>
                      <td className="py-3 px-4">
                        <button className={`flex items-center gap-1 px-3 py-1 rounded-lg text-sm font-semibold transition-colors ${report.status === 'Ready'
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-12 text-white text-center">
            <h2 className="text-3xl font-bold mb-4">Need Help with Lab Services?</h2>
            <p className="text-xl mb-8 opacity-90">Our laboratory team is available to assist you with any questions.</p>
